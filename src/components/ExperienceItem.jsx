          ...
          >
            <li className="mb-8 ml-4">
              ...
              <p className="flex flex-wrap gap-4 flex-row items-center justify-start mb-2 text-xs md:text-sm">
                ...
                <span className="text-xl text-main">{exp.name}</span>
              </p>
              <p className="flex flex-wrap gap-4 flex-row items-center justify-start text-xs md:text-sm">
                <span className="text-lg text-black">{exp.company}</span>-
                <span className="text-lg text-stone-700">{exp.workSetUp}</span>
              </p>
